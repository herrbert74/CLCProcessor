...
public interface CLCProcessorConstants {
	...
	public final String[] NEIGHBOUR_VILLAGES = {"Bakonyszentkirály", "Csatka", "Súr", "Ácsteszér", "Aka", "Bakonysárkány", "Vérteskethely", "Ete"};
	public final String[] EXCLUDED_VILLAGES = {"Sikátor", "Veszprémvarsány", "Mezőörs", "Táp", "Tápszentmiklós", "Tárkány"};*/
	public final String[] MAIN_VILLAGES = {"Hegyeshalom", "Levél", "Mosonmagyaróvár"};
	public final String[] NEIGHBOUR_VILLAGES = {"Mosonszolnok", "Újrónafő", "Károlyháza"};
	public final String[] EXCLUDED_VILLAGES = {"Rajka", "Bezenye", "Feketeerdő", "Halászi", "Máriakálnok", "Kimle" };
}
